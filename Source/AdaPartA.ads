...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_adaparta" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6676d08f#;
   pragma Export (C, u00001, "adapartaB");
   ...
   u00104 : constant Version_32 := 16#c16baf2a#;
